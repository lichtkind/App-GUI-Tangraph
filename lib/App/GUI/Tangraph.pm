...
package App::GUI::Tangraph;
our $NAME = __PACKAGE__;
our $VERSION = '0.01';

use base qw/Wx::App/;
use App::GUI::Tangraph::Frame;

sub OnInit {
    my $app   = shift;
    my $frame = App::GUI::Tangraph::Frame->new( undef, 'Tangraph '.$VERSION);
    $frame->Show(1);
...
App::GUI::Tangraph - draw art by systems of dynamic equations
...
=for HTML <p>
<img src="https://raw.githubusercontent.com/lichtkind/App-GUI-Tangraph/main/examples/wirbel.jpg"    alt=""  width="300" height="300">
<img src="https://raw.githubusercontent.com/lichtkind/App-GUI-Tangraph/main/examples/hose.png"      alt=""  width="300" height="300">
<img src="https://raw.githubusercontent.com/lichtkind/App-GUI-Tangraph/main/examples/wirbel_4.png"  alt=""  width="300" height="300">
<img src="https://raw.githubusercontent.com/lichtkind/App-GUI-Tangraph/main/examples/df.png"        alt=""  width="300" height="300">
<img src="https://raw.githubusercontent.com/lichtkind/App-GUI-Tangraph/main/examples/wolke.png"     alt=""  width="300" height="300">
</p>
...
config file .tangraph. There you can store your favorite colors under
